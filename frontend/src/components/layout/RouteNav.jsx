...
const PATRON_ITEMS = [
  ...
  { to: P.userCatalog,   label: 'Browse',  end: true },
...
const LIBRARIAN_ITEMS = [
  ...
  { to: P.adminBorrows,      label: 'Borrows',     end: true },
  { to: P.adminUsers,        label: 'Members',     end: true },
  { to: P.adminMaterials,    label: 'Collections', end: true },
